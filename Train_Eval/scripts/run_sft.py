...
def main():
    ...
    # Skip setup_chat_format for Qwen2 and GPT-2 models as they already have proper chat template
    if "<|im_start|>" in tokenizer.chat_template and "gemma-tokenizer-chatml" not in tokenizer.name_or_path and "qwen2" not in model_args.model_name_or_path.lower() and "gpt2" not in model_args.model_name_or_path.lower():
